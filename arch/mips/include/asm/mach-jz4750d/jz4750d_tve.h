/*
 * linux/include/asm-mips/mach-jz4750d/jz4750d_TVE.h
 *
 * JZ4750D TVE definition.
 *
...
#ifndef __ASM_JZ4750D_TVE_H__
#define __ASM_JZ4750D_TVE_H__
...
#define __tve_get_video_line_num()\
	(((REG_TVE_FRCFG & TVE_FRCFG_NLINE_MASK) >> TVE_FRCFG_NLINE_BIT) \
	- 1 - 2 * ((REG_TVE_FRCFG & TVE_FRCFG_L1ST_MASK) >> TVE_FRCFG_L1ST_BIT))
