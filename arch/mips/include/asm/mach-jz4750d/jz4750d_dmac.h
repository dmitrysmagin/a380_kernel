/*
 * linux/include/asm-mips/mach-jz4750d/jz4750d_dmac.h
 *
 * JZ4750D DMAC definition.
 *
...
#ifndef __ASM_JZ4750D_DMAC_H__
#define __ASM_JZ4750D_DMAC_H__
...
#define __dmac_channel_irq_detected(n) \
	( REG_DMAC_DMAIPR((n)/HALF_DMA_NUM) & (1 << ((n)-(n)/HALF_DMA_NUM*HALF_DMA_NUM)) )
#define __dmac_channel_ack_irq(n) \
	( REG_DMAC_DMAIPR((n)/HALF_DMA_NUM) &= ~(1 <<((n)-(n)/HALF_DMA_NUM*HALF_DMA_NUM)) )
