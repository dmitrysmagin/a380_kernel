...
#define JZ4750D_GPIO_BASE_A (32*0)
#define JZ4750D_GPIO_BASE_B (32*1)
#define JZ4750D_GPIO_BASE_C (32*2)
#define JZ4750D_GPIO_BASE_D (32*3)
#define JZ4750D_GPIO_BASE_E (32*4)
#define JZ4750D_GPIO_BASE_F (32*5)

#define JZ4750D_GPIO_NUM_A 32
#define JZ4750D_GPIO_NUM_B 32
#define JZ4750D_GPIO_NUM_C 32
#define JZ4750D_GPIO_NUM_D 32
#define JZ4750D_GPIO_NUM_E 32
#define JZ4750D_GPIO_NUM_F 32

#define JZ4750D_IRQ_GPIO_BASE_A (JZ4750D_IRQ_GPIO(0) + JZ4750D_GPIO_BASE_A)
#define JZ4750D_IRQ_GPIO_BASE_B (JZ4750D_IRQ_GPIO(0) + JZ4750D_GPIO_BASE_B)
#define JZ4750D_IRQ_GPIO_BASE_C (JZ4750D_IRQ_GPIO(0) + JZ4750D_GPIO_BASE_C)
#define JZ4750D_IRQ_GPIO_BASE_D (JZ4750D_IRQ_GPIO(0) + JZ4750D_GPIO_BASE_D)
#define JZ4750D_IRQ_GPIO_BASE_E (JZ4750D_IRQ_GPIO(0) + JZ4750D_GPIO_BASE_E)
#define JZ4750D_IRQ_GPIO_BASE_F (JZ4750D_IRQ_GPIO(0) + JZ4750D_GPIO_BASE_F)
...
{
	return JZ4750D_IRQ_GPIO(0) + gpio;
}
EXPORT_SYMBOL_GPL(gpio_to_irq);

int irq_to_gpio(unsigned irq)
{
	return irq - JZ4750D_IRQ_GPIO(0);
}
...
static void jz_gpio_irq_demux_handler(unsigned int irq, struct irq_desc *desc)
{
	...
	gpio_bank = JZ4750D_IRQ_GPIO0 - irq;
	...
	gpio_irq += (gpio_bank << 5) + JZ4750D_IRQ_GPIO(0);
...
#define JZ4750D_GPIO_CHIP(_bank) { \
	.irq_base = JZ4750D_IRQ_GPIO_BASE_ ## _bank, \
	.gpio_chip = { \
		.label = "Bank " # _bank, \
		.owner = THIS_MODULE, \
		...
		.base = JZ4750D_GPIO_BASE_ ## _bank, \
		.ngpio = JZ4750D_GPIO_NUM_ ## _bank, \
	}, \
}
...
static void jz4740_gpio_chip_init(struct jz_gpio_chip *chip, unsigned int id)
{
	...
	chip->base = ioremap(JZ4750D_GPIO_BASE_ADDR + (id * 0x100), 0x100);

	gpiochip_add(&chip->gpio_chip);

	chip->irq = JZ4750D_IRQ_INTC_GPIO(id);
...
static int __init jz4740_gpio_init(void)
{
	...
	printk(KERN_INFO "JZ4750D GPIO initialized\n");
