...
void fm_codec_init()
{
	...
	//set 
	dlv_write_reg(22, 0xC2); //CR3
	mdelay(20);
	dlv_write_reg_bit(1, 1, 2);//CR1.BYPASS->1
	mdelay(20);
	dlv_write_reg_bit(2, 0, 3);//CR2.ADWL->16bit
	mdelay(20);
	dlv_write_reg_bit(2, 0, 4);
	mdelay(20);
	dlv_write_reg_bit(2, 0, 5);//CR2.DAWL->16bit
	mdelay(20);
	dlv_write_reg_bit(2, 0, 6);
	mdelay(20);
		
	dlv_write_reg_bit(6, 0, 5);//PMR2.GIM->0
	mdelay(20);
	dlv_write_reg_bit(5, 0, 6);//PMR1.SB_OUT->0
	mdelay(20);
...
EXPORT_SYMBOL(fm_codec_init);

void fm_codec_uninit()
{
