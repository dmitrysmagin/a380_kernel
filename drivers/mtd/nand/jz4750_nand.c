...
offset:8 * 0x100000,
       rl_size:120 * 0x100000,
       cpu_mode: 1,
       use_planes: 0,
       mtdblock_jz_invalid: 1},
	{name:"NAND DATA1 partition",
offset:128 * 0x100000,
       rl_size:128 * 0x100000,
       cpu_mode: 1,
       use_planes: 1,
       mtdblock_jz_invalid: 1},
	{name:"NAND DATA2 partition",
offset:256 * 0x100000,
       rl_size:256 * 0x100000,
       cpu_mode: 1,
       use_planes: 1,
       mtdblock_jz_invalid: 1},
	{name:"NAND VFAT partition",
offset:512 * 0x100000,
       rl_size:512 * 0x100000,
       cpu_mode: 0,
       use_planes: 1,
...
//kaka add here
#if defined(CONFIG_JZ4750D_320E)
struct mtd_partition partition_info[] = {
	{
name:"NAND BOOT partition",
     offset:0 * 0x100000LL,
...
name:"NAND ROOTFS partition",
     offset:8 * 0x100000LL,
     rl_size:0x80 * 0x100000LL,
     cpu_mode: 1,
     use_planes: 0,
     mtdblock_jz_invalid: 1
	},
	{
name:"NAND APPFS1 partition",
     offset:0x88 * 0x100000LL,
     rl_size:0x60 * 0x100000LL,
     cpu_mode: 1,
     use_planes: 0,
     mtdblock_jz_invalid: 1
	},
	{
name:"NAND CFGFS2 partition",
     offset:0xe8 * 0x100000LL,
     rl_size:0x14 * 0x100000LL,
     cpu_mode: 1,
     use_planes: 0,
     mtdblock_jz_invalid: 1
	},
	{
name:"NAND VFAT partition",
     offset:0x100 * 0x100000LL,
     rl_size:0x700*0x100000LL,
     cpu_mode: 1,
     use_planes: 0,
     mtdblock_jz_invalid: 0
	},
